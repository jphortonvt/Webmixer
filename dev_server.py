...
def transcode_session(session_id):
    ...
    if _ffmpeg_available:
        ...
        # Safe default of 2 concurrent transcodes to avoid resource/memory exhaustion on restricted servers.
        concurrency = int(os.environ.get('TRANSCODE_CONCURRENCY', '2'))
        print(f"[DEV TRANSCODE] Starting session {session_id} with concurrency limit of {concurrency}...")
